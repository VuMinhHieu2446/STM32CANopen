...
#define CO_CONFIG_FIFO CO_CONFIG_FIFO_ENABLE		//tự config

//#define CO_CONFIG_NMT  CO_CONFIG_NMT_MASTER			//tự config
//#define CO_CONFIG_NMT (CO_CONFIG_NMT_MASTER | CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_TIMERNEXT)
//
//#define CO_CONFIG_SDO_CLI CO_CONFIG_SDO_CLI_ENABLE	//tự config
...
typedef struct {
    uint32_t ident;		//identify, Ex: SDO: 600+id, TPDO1: 200+id
    uint8_t DLC;
    uint8_t data[8];
